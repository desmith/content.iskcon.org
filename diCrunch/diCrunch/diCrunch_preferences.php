...
if (!empty($_POST['preferences'])) {
	...
	$empties = array("fileoutput", "vtob", "removedot", "swapy", "splitbox");
	...
	setcookie("diCrunch_config", "{$_POST['src']}|||{$_POST['tgt']}|||{$_POST['stylesheet']}|||{$_POST['textfont']}|||{$_POST['textwidth']}|||{$_POST['textheight']}|||{$_POST['fileoutput']}|||{$_POST['vtob']}|||{$_POST['removedot']}|||{$_POST['swapy']}|||{$_POST['splitbox']}|||{$_POST['fontsize']}|||{$_POST['c_search']}|||{$_POST['c_replace']}", (time() + 315360000));
