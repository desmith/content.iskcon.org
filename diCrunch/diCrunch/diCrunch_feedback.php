...
if (!empty($_POST['Message'])) {
	...
	CWS;
			...
			echo <<<CWS
	<div style="font: 12px Verdana; color: red;"><h1>Failed spamming attempt.</h1> Please do not send links to us over the contact form. Your IP-address {$_SERVER['REMOTE_ADDR']} has been logged. Repeated attempts will lead to action. If you feel you have received this message in error, please contact the webmaster.</div>
	CWS;
			exit;
		}
	...
	$headers .= "From: diCrunch <dicrunch@bhasa.net>\r\n";
	$headers .= "Reply-to: {$_POST['Name']} <{$_POST['Email']}>\r\n";
	$headers .= "Bcc: ragadesign@gmail.com\r\n";

	if (mail("dicrunch@bhasa.net", "diCrunch feedback module - {$_POST['Subject']}", $head . $msg . $foot, $headers)) {
...
<b>Use the feedback module</b> for sending appreciations, bug reports, feedback or questions or to the developers. If you are expecting a reply to a question, before using this module: <br /><br />

<b>1.</b> Read through the <a href="{$_SERVER['PHP_SELF']}?act=help">Help Section</a><br />
<b>2.</b> Read through the <a href="http://wiki.gaudiyakutir.com/gkWiki:DiCrunch" target="_blank">Project Page</a><br />
<b>3.</b> Have a look at the <a href="http://www.bhasa.net/viewforum.php?f=59" target="_blank">Support Forum</a><br />
</div>
...
<input name="Location" type="hidden" value="http://{$_SERVER['HTTP_HOST']}{$_SERVER['REQUEST_URI']}" />
