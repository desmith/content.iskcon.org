...
if (in_array($_POST['src'], $indic_scripts)) {
...
if (in_array($_POST['tgt'], $indic_scripts)) {
...
<h2>Diacritic Conversion &middot; diCrunch {$version}</h2>
...
&nbsp; &nbsp;
		...
		<input type="button" class="button" onclick="changeView('moreoptions');" value="More" />
...
<acronym title="Show a separate input and output text area.">Split box</acronym> <input type="checkbox" name="splitbox"{$splitbox_sel} value="1" style="vertical-align: bottom;" />
...
<div class="wrapper" id="fileoptions" style="padding-top: 0px; margin-top: -6px; display: {$fileoutput_display};">
	...
	<acronym title="You'll be prompted to download the file in TXT format.">Output to file</acronym> <input type="checkbox" name="fileoutput"{$fileoutput_sel} value="1" style="vertical-align: bottom;" />
...
<div class="copyright">[ <a href="http://wiki.gaudiyakutir.com/gkWiki:DiCrunch" target="_blank">diCrunch</a> {$version} &copy; 2006-{$y} <a href="http://www.madhavananda.com/" target="_blank">mAdhavAnanda</a> <b>&middot;</b> a <a href="http://www.bhasa.net/" target="_blank">Bhasa.Net</a> resource ]</div>
